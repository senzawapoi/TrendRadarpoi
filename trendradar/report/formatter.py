...
def format_title_for_platform(
    ...
    if platform == "feishu":
        ...
        if show_source:
            result = f"<font color='grey'>[{title_data['source_name']}]</font> {title_prefix}{title_content}"
        elif show_keyword and keyword:
            result = f"<font color='blue'>[{keyword}]</font> {title_prefix}{title_content}"
        else:
            result = f"{title_prefix}{title_content}"
        ...
        # WeWork 和 Bark 使用 markdown 格式，支持双语翻译
        if link_url:
            formatted_title = f"[{cleaned_title}]({link_url})"
        else:
            formatted_title = cleaned_title
        ...
        if show_source:
            result = f"[{title_data['source_name']}] {title_prefix}{title_content}"
        elif show_keyword and keyword:
            result = f"[{keyword}] {title_prefix}{title_content}"
        else:
            result = f"{title_prefix}{title_content}"
