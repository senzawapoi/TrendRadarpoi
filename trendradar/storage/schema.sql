...
CREATE TABLE IF NOT EXISTS news_items (
    ...
    title_translated TEXT DEFAULT '',     -- 翻译后的标题 (EN->ZH)
    title_english TEXT DEFAULT '',        -- 英文翻译 (ZH->EN)
    summary TEXT DEFAULT '',              -- 原始摘要
    summary_translated TEXT DEFAULT '',   -- 翻译后的摘要 (EN->ZH)
    summary_english TEXT DEFAULT '',      -- 英文摘要翻译 (ZH->EN)
